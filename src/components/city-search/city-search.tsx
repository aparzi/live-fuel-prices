...
// @ts-ignore
const CitySearch = ({selectedCity, onCityChange}) => {
    const cities = [
        { name: 'Campobasso', code: {lat: 41.5602544, lng: 14.6627161} as IGeographicInfo },
        { name: 'Bojano', code: {lat: 41.485586399777446, lng: 14.47291894826092} as IGeographicInfo },
        ...
        <Container className='text-center'>
            <Row>
                <Col>
                    ...
                    <Dropdown value={selectedCity} options={cities} onChange={onCityChange} optionLabel="name" placeholder="Selziona una città" />
